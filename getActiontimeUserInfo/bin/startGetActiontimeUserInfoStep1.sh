...
output="hdfs://hadoop100:9000/dataCenter/getActiontimeUserInfo/step1/${time_path}"
num=2
level=4
...
--class getActiontimeUserInfoStep1 \
...
/data/soft/jobs/getActiontimeUserInfo-1.0-SNAPSHOT.jar  ${appName} ${masterUrl} ${boltUrl} ${user} ${password} ${start_timestamp} ${output} ${num} ${level}
